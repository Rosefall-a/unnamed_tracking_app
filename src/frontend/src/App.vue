...
const startupMessage = computed(() => {
  switch (serverStartupPhase.value) {
    case "waiting_for_database": return "Waiting for the database…";
    case "running_migrations": return "Updating the database…";
    case "starting_api": return "Starting the application server…";
    case "ready": return "Server ready";
    default: return "Starting the server…";
  }
});

const startupDetail = computed(() => {
  switch (serverStartupPhase.value) {
    case "waiting_for_database": return "The backend is waiting for PostgreSQL to become ready.";
    case "running_migrations": return "Applying database migrations and preparing your data.";
    case "starting_api": return "Almost there. The API is starting and the application will load automatically.";
    default: return "The backend is starting. This page will continue checking automatically.";
  }
});
