...
// only auto-fill the folder name while the user hasn't typed their own —
...
async function submit() {
  ...
  try {
    ...
    // images go through the separate upload endpoint, and only make sense
    // against a real backend row — skip entirely in mock mode
