...
<template>
  <section class="section">
    ...
    <p class="hint">Admin-only deployment credentials for metadata and external services. Secrets are encrypted in the database and are never returned to the browser after saving. Existing environment variables remain supported as fallbacks.</p>
    ...
    <template v-else>
      ...
      <p class="hint">OpenID Connect / SSO has its own tab so authentication settings can be managed separately.</p>
