    ...
    <template v-else>
      <div class="section-heading">
        ...
        <div class="heading-actions">
          ...
          <button type="button" class="primary-button compact" @click="showInviteForm ? (showInviteForm = false) : openInviteForm()">{{ showInviteForm ? "Cancel invite" : "+ Invite user" }}</button>
        </div>
      </div>
