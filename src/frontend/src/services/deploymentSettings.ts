export interface OidcProviderSetting {
  name: string; slug: string; issuer_url: string; client_id: string; scopes: string; redirect_uri: string | null;
  groups_claim: string; admin_group: string | null; user_match_field: string; allow_new_users: boolean;
  button_text: string; button_image_url: string | null; enabled: boolean; client_secret_configured: boolean;
}
export interface DeploymentSettings {
  providers: Record<string, string | boolean | null>;
  oidc: {
    issuer_url: string | null; client_id: string | null; scopes: string | null; redirect_uri: string | null; groups_claim: string | null;
    admin_group: string | null; user_match_field: string | null; default_login_method: string | null; login_button_text: string | null;
    allow_new_users: boolean; client_secret_configured: boolean; named_providers: OidcProviderSetting[];
  };
}
