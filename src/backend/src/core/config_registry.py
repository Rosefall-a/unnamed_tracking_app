...
CONFIG_REGISTRY: tuple[ConfigSpec, ...] = (
    ConfigSpec(
        "POSTGRES_USER", "database", ConfigSource.ENV, label="PostgreSQL user", required=True
    ),
    ConfigSpec(
        "POSTGRES_PASSWORD",
        "database",
    ...
    ConfigSpec(
        "POSTGRES_DB", "database", ConfigSource.ENV, label="PostgreSQL database", required=True
    ),
    ConfigSpec(
        "POSTGRES_HOST", "database", ConfigSource.ENV, label="PostgreSQL host", default="db"
    ),
    ConfigSpec(
        "POSTGRES_PORT",
        "database",
