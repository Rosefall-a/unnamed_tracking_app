...
CONFIG_REGISTRY: tuple[ConfigSpec, ...] = (
    ...
    ConfigSpec(
        "DATABASE_URL", "database", ConfigSource.ENV, label="Legacy database URL",
        deprecated=True,
    ...
    ConfigSpec(
        "SECRET_KEY", "database", ConfigSource.ENV, label="Secret key", input_type="secret",
        secret=True, generated=True, visible=False,
        description="Stable Fernet/session signing key; generated and persisted when omitted.",
    ),
    ConfigSpec(
        "AUTH_COOKIE_SECURE", "database", ConfigSource.ENV, label="Secure authentication cookies",
        input_type="boolean", default=False,
    ...
    ConfigSpec("TMDB_API_KEY", "api_keys", label="TMDB API key", input_type="secret", secret=True, visible=False, storage="app_integration"),
    ConfigSpec("OMDB_API_KEY", "api_keys", label="OMDB API key", input_type="secret", secret=True, visible=False, storage="app_integration"),
    ConfigSpec("TVDB_API_KEY", "api_keys", label="TVDB API key", input_type="secret", secret=True, visible=False, storage="app_integration"),
    ConfigSpec("SCREENSCRAPER_DEVID", "api_keys", label="ScreenScraper developer ID", storage="app_integration"),
    ConfigSpec("SCREENSCRAPER_DEVPASSWORD", "api_keys", label="ScreenScraper developer password", input_type="secret", secret=True, visible=False, storage="app_integration"),
    ConfigSpec("SCREENSCRAPER_SSID", "api_keys", label="ScreenScraper session ID", storage="app_integration"),
    ConfigSpec("SCREENSCRAPER_SSPASSWORD", "api_keys", label="ScreenScraper session password", input_type="secret", secret=True, visible=False, storage="app_integration"),
    ConfigSpec("XBOX_CLIENT_ID", "api_keys", label="Xbox client ID", storage="app_integration"),
    ConfigSpec("XBOX_CLIENT_SECRET", "api_keys", label="Xbox client secret", input_type="secret", secret=True, visible=False, storage="app_integration"),
