...
def downgrade() -> None:
    ...
    op.drop_index('ix_games_user_folder_location_active', table_name='games', postgresql_where=sa.text('deleted_at IS NULL'))
    op.drop_index(op.f('ix_games_playnite_guid'), table_name='games')
    op.drop_index(op.f('ix_games_parent_game_id'), table_name='games')
    op.create_index('ix_games_folder_location_active', 'games', ['folder_location'], unique=True, postgresql_where='(deleted_at IS NULL)')
